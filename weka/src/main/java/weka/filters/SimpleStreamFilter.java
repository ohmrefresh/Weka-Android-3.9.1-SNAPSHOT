 ...
 *     return &quot;A simple stream filter that adds an attribute 'bla' at the end containing a
 * random number.&quot;;
 *   }
 *
...
public abstract class SimpleStreamFilter extends SimpleFilter implements StreamableFilter {
   ...
   */
  @Override protected abstract Instances determineOutputFormat(Instances inputFormat)
      throws Exception;
}
