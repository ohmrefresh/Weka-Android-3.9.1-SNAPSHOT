...
public class PKIDiscretize extends Discretize implements TechnicalInformationHandler {
   ...
   */
  @Override protected void findNumBins(int index) {
   ...
   * explorer/experimenter gui
   */
  @Override public String findNumBinsTipText() {
   ...
   */
  @Override public boolean getFindNumBins() {
   ...
   */
  @Override public void setFindNumBins(boolean newFindNumBins) {
   ...
   * explorer/experimenter gui
   */
  @Override public String useEqualFrequencyTipText() {
   ...
   */
  @Override public boolean getUseEqualFrequency() {
   ...
   */
  @Override public void setUseEqualFrequency(boolean newUseEqualFrequency) {
   ...
   * explorer/experimenter gui
   */
  @Override public String binsTipText() {
   ...
   */
  @Override public void setBins(int numBins) {
