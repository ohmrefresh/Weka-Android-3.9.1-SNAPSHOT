...
public class RemoveType extends Filter
   ...
   * queue is empty).
   */
  @Override public Instance output() {
   ...
   * queue is empty).
   */
  @Override public Instance outputPeek() {
   ...
   */
  @Override public boolean isOutputFormatDefined() {
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tInvert matching sense (i.e. only keep specified columns)", "V", 0, "-V"));
