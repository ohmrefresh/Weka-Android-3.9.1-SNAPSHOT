...
public class MathExpression extends PotentialClassIgnorer implements UnsupervisedFilter {
  ...
  private void convertInstance(Instance instance) throws Exception {
    ...
    for (int i = 0; i < instance.numAttributes(); i++) {
      ...
      if (m_SelectCols.isInRange(i) && instance.attribute(i).isNumeric() && !Utils.isMissingValue(
          vals[i]) && getInputFormat().classIndex() != i) {
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    result.addElement(
        new Option("\tInvert matching sense (i.e. only modify specified columns)", "V", 0, "-V"));
  ...
  private void compile() throws Exception {
    ...
    Node node = Parser.parse(
        ...
        m_expression,
        // variables
        new VariableDeclarationsCompositor(m_InstancesHelper, m_StatsHelper,
  ...
  public void setExpression(String expr) throws Exception {
    m_expression = expr;
    if (getInputFormat() != null) compile();
  }
