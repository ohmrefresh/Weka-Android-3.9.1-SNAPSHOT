...
public class AddExpression extends Filter
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option("\tSpecify the name for the new attribute. (default is the "
        + "expression provided with -E)", "N", 1, "-N <name>"));

    newVector.addElement(
        new Option("\tDebug. Names attribute with the postfix parse of the " + "expression.", "D",
            0, "-D"));
  ...
  @Override public boolean input(Instance instance) throws Exception {
    ...
    if (m_InstancesHelper.missingAccessed()) vals[vals.length - 1] = Utils.missingValue();
