...
/**
 * <!-- globalinfo-start -->
 * A filter that can be used to introduce missing values in a dataset. The specified probability is
 * used to flip a biased coin to decide whether to replace a particular attribute value in an
 * instance with a missing value (i.e., a probability of 0.9 means 90% of values will be replaced
 * with missing values). This filter only modifies the first batch of data that is processed.
 * <br><br>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
...
public class ReplaceWithMissingValue extends SimpleBatchFilter
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option("\tSpecifies list of columns to modify. First"
    ...
    result.addElement(
        new Option("\tSpecify the random number seed (default 1)", "S", 1, "-S <num>"));

    result.addElement(
        new Option("\tSpecify the probability  (default 0.1)", "P", 1, "-P <double>"));
  ...
  @Override public String globalInfo() {
    return
        "A filter that can be used to introduce missing values in a dataset. The specified probability is used to"
            +
