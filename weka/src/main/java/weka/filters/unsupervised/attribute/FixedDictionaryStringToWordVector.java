...
public class FixedDictionaryStringToWordVector extends SimpleStreamFilter
  ...
  @OptionMetadata(displayName = "Dictionary file",
      ...
      displayOrder = 1) public void setDictionaryFile(File file) {
  ...
  @OptionMetadata(displayName = "Dictionary is binary",
      ...
      displayOrder = 2) public void setDictionaryIsBinary(boolean binary) {
  ...
  @OptionMetadata(displayName = "Output word counts",
      description =
          "Output word counts rather than boolean 0 or 1 (indicating presence or absence of "
              + "a word",
      commandLineParamName = "C", commandLineParamSynopsis = "-C",
      commandLineParamIsFlag = true, displayOrder = 3) public void setOutputWordCounts(
  ...
  @OptionMetadata(displayName = "Range of attributes to operate on",
      ...
      displayOrder = 4) public void setAttributeIndices(String rangeList) {
  ...
  @OptionMetadata(displayName = "Invert selection",
      ...
      commandLineParamIsFlag = true, displayOrder = 5) public void setInvertSelection(
      boolean invert) {
  ...
  @OptionMetadata(displayName = "TFT transform",
      ...
      displayOrder = 7) public void setTFTransform(boolean TFTransform) {
  ...
  @OptionMetadata(displayName = "IDF transform",
      ...
      displayOrder = 8) public void setIDFTransform(boolean IDFTransform) {
  ...
  @OptionMetadata(displayName = "Normalize word frequencies",
      ...
      commandLineParamIsFlag = true, displayOrder = 9) public void setNormalizeDocLength(
      boolean normalize) {
  ...
  @OptionMetadata(displayName = "Lower case tokens",
      ...
      commandLineParamIsFlag = true, displayOrder = 10) public void setLowerCaseTokens(
      boolean downCaseTokens) {
  ...
  @OptionMetadata(displayName = "Stemmer to use",
      ...
      commandLineParamSynopsis = "-stemmer <spec>", displayOrder = 11) public void setStemmer(
      Stemmer value) {
    if (value != null) {
  ...
  @OptionMetadata(displayName = "Tokenizer",
      ...
      commandLineParamSynopsis = "-tokenizer <spec>", displayOrder = 13) public void setTokenizer(
      Tokenizer value) {
  ...
  @Override protected Instances determineOutputFormat(Instances inputFormat) throws Exception {
    ...
    if (m_vectorizer.readyToVectorize() && inputFormat.equalHeaders(
        m_vectorizer.getInputFormat())) {
    ...
    if (m_dictionarySource != null) {
      ...
      if (!dictFile.exists()) {
        throw new IOException(
            "Specified dictionary file '" + fString + "' does not seem to exist!");
      }
