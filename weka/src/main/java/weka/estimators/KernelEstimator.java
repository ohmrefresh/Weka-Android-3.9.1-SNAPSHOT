 ...
 */
public class KernelEstimator extends Estimator
  ...
  @Override public String toString() {
    ...
    String result =
        m_NumValues + " Normal Kernels. \nStandardDev = " + Utils.doubleToString(m_StandardDev, 6,
            4) + " Precision = " + m_Precision;
    if (m_NumValues == 0) {
      result += "  \nMean = 0";
    } else {
      result += "  \nMeans =";
  ...
  @Override public KernelEstimator aggregate(KernelEstimator toAggregate) throws Exception {
