...
public abstract class Estimator
    implements Cloneable, Serializable, OptionHandler, CapabilitiesHandler, CapabilitiesIgnorer,
    RevisionHandler {
  ...
  public static void buildEstimator(Estimator est, String[] options, boolean isIncremental)
    ...
    try {
      ...
      buildEstimator(est, build.m_instances, build.m_attrIndex, build.m_classIndex,
      ...
      if (est instanceof OptionHandler) {
        specificOptions += "\nEstimator options:\n\n";
        Enumeration<Option> enumOptions = est.listOptions();
  ...
  public static void buildEstimator(Estimator est, Instances instances, int attrIndex,
      int classIndex, int classValueIndex, boolean isIncremental) throws Exception {
    ...
    if (!isIncremental) {
      ...
      while (enumInsts.hasMoreElements()) {
        ...
        est.addValue(instance.value(attrIndex), instance.weight());
      }
    }
  }
   ...
   * @throws Exception if the estimator name is invalid, or the options
   ...
   * @throws Exception if building of estimator goes wrong
   */
   ...
   * @throws Exception if building of estimator goes wrong
   */
  public void addValues(Instances data, int attrIndex, int classIndex, int classValue, double min,
   ...
   */
  private double getInstancesFromClass(Instances data, int attrIndex, int classIndex,
  ...
  @Override public boolean equals(Object obj) {
    ...
    return m_noClass == cmp.m_noClass;
  }
