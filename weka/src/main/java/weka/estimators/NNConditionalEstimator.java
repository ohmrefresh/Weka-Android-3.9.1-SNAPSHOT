...
public class NNConditionalEstimator implements ConditionalEstimator {
  ...
  @Override public void addValue(double data, double given, double weight) {
    ...
    if ((m_Values.size() <= insertIndex) || (m_CondValues.elementAt(insertIndex).doubleValue()
        != given) || (m_Values.elementAt(insertIndex).doubleValue() != data)) {
  ...
  @Override public String toString() {
    ...
    String result = "NN Conditional Estimator. "
        ...
        + "  Conditional mean = "
        + Utils.doubleToString(m_CondMean, 4, 2);
