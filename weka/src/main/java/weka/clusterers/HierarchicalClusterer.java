 ...
 * <pre>
 * -L
 *  Link type (Single, Complete, Average, Mean, Centroid, Ward, Adjusted complete, Neighbor
 * Joining)
...
public class HierarchicalClusterer extends AbstractClusterer implements OptionHandler, Drawable {
  ...
  public static final Tag[] TAGS_LINK_TYPE = {
      new Tag(SINGLE, "SINGLE"), new Tag(COMPLETE, "COMPLETE"), new Tag(AVERAGE, "AVERAGE"),
      new Tag(MEAN, "MEAN"), new Tag(CENTROID, "CENTROID"), new Tag(WARD, "WARD"),
  ...
  void doLinkClustering(int nClusters, Vector<Integer>[] nClusterID, Node[] clusterNodes) {
    ...
    PriorityQueue<Tuple> queue =
        new PriorityQueue<Tuple>(nClusters * nClusters / 2, new TupleComparator());
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tFlag to indicate the cluster should be printed in Newick format.", "P", 0,
            "-P"));
    newVector.addElement(new Option(
  ...
  @Override public String[] getOptions() {
    ...
    options.add("-A");
    options.add((m_DistanceFunction.getClass().getName() + " " + Utils.joinOptions(
