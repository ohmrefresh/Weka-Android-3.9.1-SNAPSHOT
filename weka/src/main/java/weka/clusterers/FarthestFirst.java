 ...
 * <br/>
 * Hochbaum, Shmoys (1985). A best possible heuristic for the k-center problem. Mathematics of
 * Operations Research. 10(2):180-184.<br/>
 * <br/>
 * Sanjoy Dasgupta: Performance Guarantees for Hierarchical Clustering. In: 15th Annual Conference
 * on Computational Learning Theory, 351-363, 2002.<br/>
 * <br/>
 * Notes:<br/>
...
public class FarthestFirst extends RandomizableClusterer implements TechnicalInformationHandler {
  ...
  protected void updateMinDistance(double[] minDistance, boolean[] selected, Instances data,
      Instance center) {
  ...
  protected double difference(int index, double val1, double val2) {
    ...
    switch (m_instances.attribute(index).type()) {
      case Attribute.NOMINAL:
        ...
        if (Utils.isMissingValue(val1) || Utils.isMissingValue(val2) || ((int) val1
            != (int) val2)) {
          return 1;
        } else {
          return 0;
