...
public abstract class AbstractClusterer
    ...
    OptionHandler, CapabilitiesIgnorer, CommandlineRunnable {
   ...
   * @throws Exception if the clusterer class name is invalid, or the options
   ...
   */
  @Override public abstract void buildClusterer(Instances data) throws Exception;
   ...
   * successfully
   */
  @Override public abstract int numberOfClusters() throws Exception;
  ...
  public static void runClusterer(Clusterer clusterer, String[] options) {
    try {
      ...
      if ((e.getMessage() == null) || ((e.getMessage() != null) && (e.getMessage()
          .indexOf("General options") == -1))) {
        e.printStackTrace();
      } else {
