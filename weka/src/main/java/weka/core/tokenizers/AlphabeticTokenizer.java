...
public class AlphabeticTokenizer extends Tokenizer {
  ...
  @Override public boolean hasMoreElements() {
    ...
    while ((beginpos < m_Str.length) && ((m_Str[beginpos] < 'a') || (m_Str[beginpos] > 'z')) && ((
        m_Str[beginpos]
            < 'A') || (m_Str[beginpos] > 'Z'))) {
      beginpos++;
    }
    ...
    return (beginpos < m_Str.length) && (((m_Str[beginpos] >= 'a') && (m_Str[beginpos] <= 'z')) || (
        (m_Str[beginpos] >= 'A')
            && (m_Str[beginpos] <= 'Z')));
  }
  ...
  @Override public String nextElement() {
    ...
    while ((endpos < m_Str.length) && (((m_Str[endpos] >= 'a') && (m_Str[endpos] <= 'z'))
