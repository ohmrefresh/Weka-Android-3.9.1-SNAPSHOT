...
public class Operators {
  ...
  public static Node uplus(Node expr) throws SemanticException {
    if (expr instanceof DoubleExpression) return expr;
  ...
  public static Node uminus(Node expr) throws SemanticException {
    if (expr instanceof DoubleExpression) return new UMinus((DoubleExpression) expr);
    throw new SemanticException("unary minus is only applicable to doubles!");
  }
  ...
  public static BooleanExpression not(Node expr) throws SemanticException {
    if (expr instanceof BooleanExpression) return new Not((BooleanExpression) expr);
  ...
  private static abstract class BooleanBinaryExpression<T>
      implements BooleanExpression, Serializable {
