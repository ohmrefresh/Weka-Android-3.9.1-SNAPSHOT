 ...
 */
@SuppressWarnings({ "rawtypes" }) public class Parser extends java_cup.runtime.lr_parser {
   ...
   */
  public static Node parse(String expr, VariableDeclarations variables, MacroDeclarations macros)
      throws Exception {
  ...
  @SuppressWarnings({ "rawtypes", "unchecked", "unused" }) class CUP$Parser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$Parser$do_action(int CUP$Parser$act_num,
      ...
      return CUP$Parser$do_action_part00000000(CUP$Parser$act_num, CUP$Parser$parser,
          CUP$Parser$stack, CUP$Parser$top);
    }
    ...
    public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(int CUP$Parser$act_num,
      ...
      switch (CUP$Parser$act_num) {
        ...
        {
          Object RESULT = null;
          Node start_val = (Node) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
        ...
        case 2: // paramlist ::= paramlist COMMA expr
        {
          ...
          List<Node> l = (List<Node>) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
        ...
        {
          Node RESULT = null;
          Node e = (Node) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 1)).value;
        ...
        {
          Node RESULT = null;
          String m = (String) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 3)).value;
          List<Node> p = (List<Node>) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 1)).value;

          if (!macros.hasMacro(m)) throw new SemanticException("Macro '" + m + "' is undefined!");
        ...
        {
          Node RESULT = null;
          Node l = (Node) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
              CUP$Parser$top - 2)).value;
