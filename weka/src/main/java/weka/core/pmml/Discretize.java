...
public class Discretize extends Expression {
  ...
  private void setUpField() throws Exception {
    ...
    if (m_fieldDefs != null) {
      ...
      if (m_fieldIndex < 0) {
        throw new Exception(
            "[Discretize] Can't find field " + m_fieldName + " in the supplied field definitions.");
      }
   ...
   */
  @Override public void setFieldDefs(ArrayList<Attribute> fieldDefs) throws Exception {
   ...
   */
  @Override public double getResult(double[] incoming) throws Exception {
   ...
   */
  @Override public String getResultCategorical(double[] incoming) throws Exception {
   ...
   * Attribute.
   */
  @Override protected Attribute getOutputDef() {
    if (m_outputDef == null) {
      ...
      return
          (m_opType == FieldMetaInfo.Optype.CATEGORICAL || m_opType == FieldMetaInfo.Optype.ORDINAL)
   ...
   */
  @Override public String toString(String pad) {
  ...
  protected class DiscretizeBin implements Serializable {
    ...
    private final ArrayList<FieldMetaInfo.Interval> m_intervals =
