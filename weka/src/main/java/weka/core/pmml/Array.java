...
public class Array implements Serializable {
  ...
  public static boolean isArray(Element arrayE) {
    ...
    return name.equals("Array")
        || name.equals("NUM-ARRAY")
        || name.equals("INT-ARRAY")
        || name.equals("REAL-ARRAY")
  ...
  public enum ArrayType {
    NUM("NUM-ARRAY"), INT("INT-ARRAY"), REAL("REAL-ARRAY"), STRING("STRING-ARRAY"), REAL_SPARSE(
        "REAL-SparseArray"), INT_SPARSE("INT-SparseArray");
