...
public abstract class NormalizableDistance
   ...
   */
  @Override public void setAttributeIndices(String value) {
   ...
   */
  @Override public void setInvertSelection(boolean value) {
   ...
   */
  @Override public double distance(Instance first, Instance second, double cutOffValue) {
   ...
   */
  @Override public void update(Instance ins) {
    validate();
