...
public class DatabaseSaver extends AbstractSaver
  ...
  @OptionMetadata(displayName = "Table name",
      description = "Sets the name of the table", displayOrder = 4) public String getTableName() {
  ...
  @OptionMetadata(displayName = "Truncate table",
      ...
      displayOrder = 6) public boolean getTruncate() {
    return m_truncate;
  }
  ...
  @OptionMetadata(displayName = "Database URL",
      description = "The URL of the database", displayOrder = 1) @Override public String getUrl() {
  ...
  @OptionMetadata(
      ...
      description =
          "If set to true, a primary key column is generated automatically (containing the row number as INTEGER). The name of the key is read from DatabaseUtils (idColumn)"
      ...
      displayOrder = 7) public boolean getAutoKeyGeneration() {
  ...
  @OptionMetadata(
      ...
      displayOrder = 5) public boolean getRelationForTableName() {
  ...
  @OptionMetadata(displayName = "Username",
      description = "The user name for the database", displayOrder = 2) @Override
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tThe JDBC URL to connect to.\n" + "\t(default: from DatabaseUtils.props file)",
            "url", 1, "-url <JDBC URL>"));

    newVector.addElement(
        new Option("\tThe user to connect with to the database.\n" + "\t(default: none)", "user", 1,
            "-user <name>"));

    newVector.addElement(
        new Option("\tThe password to connect with to the database.\n" + "\t(default: none)",
            "password", 1, "-password <password>"));

    newVector.addElement(
        new Option("\tThe name of the table.\n" + "\t(default: the relation name)", "T", 1,
            "-T <table name>"));

    newVector.addElement(
        new Option("\tTruncate (i.e. delete any data) in table before inserting", "truncate", 0,
            "-truncate"));
    ...
    newVector.addElement(
        new Option("\tInput file in arff format that should be saved in database.", "i", 1,
            "-i <input file name>"));
