...
public abstract class AbstractSaver implements Saver, CapabilitiesHandler, CapabilitiesIgnorer {
   ...
   */
  @Override public String getFileExtension() throws Exception {
   ...
   * @throws IOException always
   */
  @Override public void setFilePrefix(String prefix) throws Exception {
   ...
   * @throws IOException always
   */
  @Override public String filePrefix() throws Exception {
   ...
   * @throws IOException always
   */
  @Override public void setDir(String dir) throws IOException {
   ...
   * @throws IOException always
   */
  @Override public void setDirAndPrefix(String relationName, String add) throws IOException {
   ...
   * @throws IOException always
   */
  @Override public String retrieveDir() throws IOException {
  ...
  public int setStructure(Instances headerInfo) {
    ...
    if (m_writeMode == WAIT && headerInfo != null) {
      ...
      if ((headerInfo == null) || !(m_writeMode == STRUCTURE_READY) || !headerInfo.equalHeaders(
          m_instances)) {
        m_instances = null;
        if (m_writeMode != WAIT) {
          System.err.println(
   ...
   */
  @Override public abstract void writeBatch() throws IOException;
   ...
   */
  @Override public void writeIncremental(Instance i) throws IOException {
   ...
   */
  @Override public int getWriteMode() {
   ...
   * @throws IOException always
   */
  @Override public void setDestination(File file) throws IOException {
