...
public class DictionarySaver extends AbstractFileSaver
  ...
  @Override public void resetWriter() {
    super.resetWriter();
  ...
  @OptionMetadata(displayName = "Range of attributes to operate on",
      ...
      commandLineParamSynopsis = "-R <range>", displayOrder = 4) public void setAttributeIndices(
      String rangeList) {
  ...
  @OptionMetadata(displayName = "Lower case tokens",
      ...
      displayOrder = 10) public void setLowerCaseTokens(boolean downCaseTokens) {
  ...
  @OptionMetadata(
      ...
      displayOrder = 14) public void setPeriodicPruning(long newPeriodicPruning) {
  ...
  @OptionMetadata(
      ...
      commandLineParamSynopsis = "-W <integer>", displayOrder = 15) public void setWordsToKeep(
      int newWordsToKeep) {
  ...
  @OptionMetadata(
      ...
      commandLineParamSynopsis = "-M <integer>", displayOrder = 16) public void setMinTermFreq(
      int newMinTermFreq) {
  ...
  @OptionMetadata(displayName = "Do not operate on a per-class basis",
      ...
      displayOrder = 17) public void setDoNotOperateOnPerClassBasis(
  ...
  @OptionMetadata(displayName = "Sort dictionary",
      ...
      commandLineParamIsFlag = true, displayOrder = 18) public void setKeepDictionarySorted(
      boolean sorted) {
  ...
  @OptionMetadata(displayName = "Save dictionary in binary form",
      ...
      displayOrder = 2) public void setSaveBinaryDictionary(boolean binary) {
