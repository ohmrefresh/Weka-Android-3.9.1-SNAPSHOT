...
public abstract class AbstractFileSaver extends AbstractSaver
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    Vector<Option> newVector =
        Option.listOptionsForClassHierarchy(this.getClass(), AbstractFileSaver.class);
   ...
   */
  @Override public abstract String getFileDescription();
   ...
   */
  @Override public void setFilePrefix(String prefix) {
   ...
   */
  @Override public String filePrefix() {
   ...
   */
  @Override public String retrieveDir() {
    ...
    if (outputString.length() != 0) {
      ...
      if (!validExt) {
        if (outputString.lastIndexOf('.') != -1) {
          outputString =
              (outputString.substring(0, outputString.lastIndexOf('.'))) + FILE_EXTENSION;
        } else {
   ...
   */
  @Override public void setDirAndPrefix(String relationName, String add) {
    ...
    try {
      ...
      if (m_prefix.equals("")) {
        ...
        if (!concat.toLowerCase().endsWith(FILE_EXTENSION) && !concat.toLowerCase()
            .endsWith(FILE_EXTENSION + FILE_EXTENSION_COMPRESSED)) {
