...
/**
 * <!-- globalinfo-start -->
 * An iterated version of the Lovins stemmer. It stems the word (in case it's longer than 2
 * characters) until it no further changes.<br/>
 * <br/>
...
public class IteratedLovinsStemmer extends LovinsStemmer {
  ...
  public String globalInfo() {
    return "An iterated version of the Lovins stemmer. It stems the word (in "
