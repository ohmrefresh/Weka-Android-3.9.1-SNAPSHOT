 ...
 * <br/>
 * Julie Beth Lovins (1968). Development of a stemming algorithm. Mechanical Translation and
...
public class LovinsStemmer implements Stemmer, TechnicalInformationHandler {
  ...
  private String recodeEnding(String word) {
    ...
    // Rule 9
    if (word.endsWith("ul")) {
      if ((lastPos - 2 < 0) || ((word.charAt(lastPos - 2) != 'a') &&
    ...
    if (word.endsWith("her")) {
      if ((lastPos - 3 < 0) || ((word.charAt(lastPos - 3) != 'p') && (word.charAt(lastPos - 3)
          != 't'))) {
        ...
        if (conditionCode != null) {
          switch (conditionCode.charAt(0)) {
            ...
            case 'G':
              ...
              break;
            case 'H':
              if ((word.charAt(length - el - 1) == 't') || ((word.charAt(length - el - 1) == 'l')
            ...
            case 'K':
              if ((length - el > 2) && ((word.charAt(length - el - 1) == 'l') ||
                  ...
                  ((word.charAt(length - el - 1) == 'e') && (word.charAt(length - el - 3)
                      == 'u')))) {
                return word.substring(0, length - el);
              }
              break;
            case 'L':
              if ((word.charAt(length - el - 1) != 'u') &&
                  ...
                  ((word.charAt(length - el - 1) != 's') || (word.charAt(length - el - 2)
                      == 'o'))) {
                return word.substring(0, length - el);
              }
              break;
            case 'M':
              ...
              break;
            case 'N':
              if ((length - el > 3) || ((length - el == 3) && ((word.charAt(length - el - 3)
                  != 's')))) {
                return word.substring(0, length - el);
              }
              break;
            ...
            case 'S':
              if (((word.charAt(length - el - 1) == 'r') && (word.charAt(length - el - 2) == 'd'))
                  || ((word.charAt(length - el - 1) == 't') && (word.charAt(length - el - 2)
                  != 't'))) {
                return word.substring(0, length - el);
              }
              break;
            case 'T':
              if ((word.charAt(length - el - 1) == 's') || ((word.charAt(length - el - 1) == 't')
            ...
            case 'b':
              if (m_CompMode) {
                if (((length - el == 3) && (!((word.charAt(length - el - 1) == 't') &&
                    ...
                    (word.charAt(length - el - 3) == 'm')))) || ((length - el > 3)
                    && (!((word.charAt(length - el - 1) == 't') &&
