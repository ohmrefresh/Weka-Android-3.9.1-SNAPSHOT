...
public abstract class AbstractInstance implements Instance, Serializable, RevisionHandler {
  ...
  @Override public/* @pure@ */Attribute attribute(int index) {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public/* @pure@ */Attribute attributeSparse(int indexOfIndex) {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public/* @pure@ */Attribute classAttribute() {
  ...
  @Override public/* @pure@ */int classIndex() {
  ...
  @Override public/* @pure@ */boolean classIsMissing() {
   ...
   */
  // @ requires classIndex() >= 0;
  @Override public/* @pure@ */double classValue() {
  ...
  @Override public/* @pure@ */Instances dataset() {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public/* @pure@ */Enumeration<Attribute> enumerateAttributes() {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public/* @pure@ */boolean equalHeaders(Instance inst) {
   ...
   * differ
   */
  @Override public String equalHeadersMsg(Instance inst) {
    if (m_Dataset == null) {
      throw new UnassignedDatasetException("Instance doesn't have access to a dataset!");
    }
   ...
   */
  // @ requires m_Dataset != null;
  @Override public/* @pure@ */boolean hasMissingValue() {
   ...
   */
  @Override public/* @pure@ */boolean isMissing(int attIndex) {

    return Utils.isMissingValue(value(attIndex));
  }
   ...
   * @return true if the value is "missing"
   */
  @Override public/* @pure@ */boolean isMissingSparse(int indexOfIndex) {

    return Utils.isMissingValue(valueSparse(indexOfIndex));
  }
   ...
   * @return true if the value is "missing"
   */
  @Override public/* @pure@ */boolean isMissing(Attribute att) {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public/* @pure@ */int numClasses() {
   ...
   */
  // @ requires classIndex() >= 0;
  @Override public final void setClassValue(String value) {
   ...
   */
  @Override public final void setDataset(Instances instances) {
   ...
   * @param attIndex the attribute's index
   */
  @Override public final void setMissing(int attIndex) {
   ...
   * @param att the attribute
   */
  @Override public final void setMissing(Attribute att) {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public final void setValue(int attIndex, String value) {
   ...
   * double).
   */
  @Override public final void setValue(Attribute att, double value) {
   ...
   * string, or the value couldn't be found for a nominal attribute
   */
  @Override public final void setValue(Attribute att, String value) {
   ...
   */
  @Override public final void setWeight(double weight) {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public final/* @pure@ */Instances relationalValue(int attIndex) {
   ...
   * dataset.
   */
  @Override public final/* @pure@ */Instances relationalValue(Attribute att) {
   ...
   */
  // @ requires m_Dataset != null;
  @Override public final/* @pure@ */String stringValue(int attIndex) {
   ...
   * dataset.
   */
  @Override public final/* @pure@ */String stringValue(Attribute att) {
   ...
   * @return the instance's description as a string
   */
  @Override public final String toStringMaxDecimalDigits(int afterDecimalPoint) {
   ...
   */
  @Override public final String toString(int attIndex) {
   ...
   * @return the value's description as a string
   */
  @Override public final/* @pure@ */String toString(int attIndex, int afterDecimalPoint) {
   ...
   * @return the value's description as a string
   */
  @Override public final String toString(Attribute att) {
   ...
   * @return the value's description as a string
   */
  @Override public final String toString(Attribute att, int afterDecimalPoint) {
   ...
   * double).
   */
  @Override public/* @pure@ */double value(Attribute att) {
   ...
   * double).
   */
  @Override public/* @pure@ */double valueSparse(int indexOfIndex) {
   ...
   */
  @Override public final/* @pure@ */double weight() {
