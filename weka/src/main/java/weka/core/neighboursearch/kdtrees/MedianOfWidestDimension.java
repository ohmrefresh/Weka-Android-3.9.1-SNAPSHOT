...
/**
 * <!-- globalinfo-start -->
 * The class that splits a KDTree node based on the median value of a dimension in which the node's
 * points have the widest spread.<br/>
 * <br/>
 * For more information see also:<br/>
 * <br/>
 * Jerome H. Friedman, Jon Luis Bentley, Raphael Ari Finkel (1977). An Algorithm for Finding Best
 * Matches in Logarithmic Expected Time. ACM Transactions on Mathematics Software. 3(3):209-226.
 * <p/>
 * <!-- globalinfo-end -->
 *
...
public class MedianOfWidestDimension extends KDTreeNodeSplitter
  ...
  public String globalInfo() {
    return "The class that splits a KDTree node based on the median value of "
  ...
  public void splitNode(KDTreeNode node, int numNodesCreated, double[][] nodeRanges,
    ...
    int medianIdx =
        select(splitDim, m_InstList, node.m_Start, node.m_End, (node.m_End - node.m_Start) / 2 + 1);
