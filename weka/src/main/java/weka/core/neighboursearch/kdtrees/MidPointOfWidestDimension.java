...
/**
 * <!-- globalinfo-start -->
 * The class that splits a KDTree node based on the midpoint value of a dimension in which the
 * node's points have the widest spread.<br/>
 * <br/>
...
public class MidPointOfWidestDimension extends KDTreeNodeSplitter
  ...
  public String globalInfo() {
    return "The class that splits a KDTree node based on the midpoint value of "
