...
/**
 * <!-- globalinfo-start -->
 * Implements the Manhattan distance (or Taxicab geometry). The distance between two points is the
 * sum of the (absolute) differences of their coordinates.<br/>
 * <br/>
...
public class ManhattanDistance extends NormalizableDistance implements TechnicalInformationHandler {
  ...
  public String globalInfo() {
    return "Implements the Manhattan distance (or Taxicab geometry). The distance "
