...
/**
 * <!-- globalinfo-start -->
 * Uses the stopwords located in the specified file (ignored _if pointing to a directory). One
 * stopword per line. Lines starting with '#' are considered comments and ignored.
 * <p/>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
