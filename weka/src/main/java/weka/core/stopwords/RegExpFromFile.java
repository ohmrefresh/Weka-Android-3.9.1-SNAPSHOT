...
/**
 * <!-- globalinfo-start -->
 * Uses the regular expressions stored in the file for determining whether a word is a stopword
 * (ignored if pointing to a directory). One expression per line.
 * <p/>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
...
public class RegExpFromFile extends AbstractFileBasedStopwords {
  ...
  @Override public String globalInfo() {
    return "Uses the regular expressions stored in the file for determining "
