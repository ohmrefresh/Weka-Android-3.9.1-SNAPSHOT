...
public class DenseInstance extends AbstractInstance {
  ...
  @Override public/* @pure@ */Object copy() {
   ...
   */
  @Override public/* @pure@ */int index(int position) {
  ...
  @Override public/* @pure@ */int numAttributes() {
   ...
   */
  // @ ensures \result == m_AttValues.length;
  @Override public/* @pure@ */int numValues() {
   ...
   * double).
   */
  @Override public/* @pure@ */double value(int attIndex) {
