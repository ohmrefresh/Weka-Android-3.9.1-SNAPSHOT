...
public class Debug implements Serializable, RevisionHandler {
  ...
  */
  ...
  /**
   * logs the hat ut to the specified file (and stdout). Size is 1,000,000 bytes
   * and 1 file.
   *
  ...
  /**
   * prints thed
   * ing representing a level, e.g., "FINE" or "ALL" into
  ...
  /**
   * returns tonst
   * ault debug random object, with no particular seed and
   * debugging enabled.
   *
  ...
  /**
   * returns aoutp
   * ug random object with the specified seed and debugging
   * enabled.
   *
  ...
  /**
   * returns a doutp
   * ault timestamp for the current date/time
   *
  ...
  /**
   * returns te gi
   * urrent working directory of the user
   *
  ...
  /**
   * Writes the gi
   * ven object to the specified file. The string representation
  ...
  /**
   * Writes the gi
   * ven message to the specified file. The message is either
  ...
  /**
   * writes thher
   * ven message to the specified file. The message is appended
   * to the file.
   *
   * @param filename the file to write to
   * @param message the message to write
  ...
  /**
   * Writes thheth
   * rialized object to the speicified file
   *
  ...
  /**
   * deseriali new
   * the content of the file and returns it, null if an error
   * occurred.
   *
  ...
  /**
   * Returns the i
   * nstance of the Clock that is internally used
   *
  ...
  /**
   * prints th deb
   * ven message with the specified level and an empty sourceclass
   *
  ...
  /**
   * prints thef
   * ven message with the specified level
   *
   * @param level the level of logging
  ...
  public static class Clock implements Serializable, RevisionHandler {
    ...
    public static final Tag[] TAGS_FORMAT = {
        new Tag(FORMAT_MILLISECONDS, "milli-seconds"), new Tag(FORMAT_SECONDS, "seconds"),
  ...
  /**
   * A class te gi
   * can be used for timestamps in files, The toString() method
  ...
  public static class Timestamp implements Serializable, RevisionHandler {
    ...
    /**
     * setates a timestamp with the given date and the default format.
     *
     * @param stamp the associated date/time for the timestamp
     */
  ...
  /**
   * A little,e gi
   * ple helper class for logging stuff. Uses simple file access
  ...
  public static class SimpleLog implements Serializable, RevisionHandler {
    ...
    public void log(String message) {
      ...
      if (getFilename() != null) Debug.writeToFile(getFilename(), log);
    ...
    /**
     * s the
     * he filename of the log, can be null
     *
    ...
    /**
     * log * returns a string representation of the logger
     *
  ...
  /**
   * A helper e gi
   * s for logging stuff. Uses the java.util.logging
  ...
  public static class Log implements Serializable, RevisionHandler {
    ...
    /**
     * initializ
     * string representing a level, e.g., "FINE" or "ALL" into
     * the corresponding level (case-insensitive). The default is ALL.
     *
     * @param level the string to return a level for
     * @return the corresponding level or the default
    ...
    /**
     * priurns t
     * e given message with the specified level
     *
     * @param level the level of logging
     * @param sourceclass the class that logs the message
     * @param message the message to print
    ...
    /**
     * prihe filename of the log, can be null
     *
     * @return the filename of the log
     */
    public String getFilename() {
    ...
    /**
     * returns t
     * es and returns the logger if necessary (e.g., due to
     * serialization).
     *
    ...
    /**
     * turhe number of files being used
     *
    ...
    /**
     * logs the nts thnts th * returns a string representation of the logger
     *
     * @return a string representation of the logger
     */
    public String toString() {
  ...
  /**
   * This extende se
   * Random class enables one to print the generated random
  ...
  public static class Random extends java.util.Random implements Serializable, RevisionHandler {
    ...
    /** whether to outpuk of unique IDs */
    protected static long m_CurrentID;

    /** the log tofot debug information */
    protected boolean m_Debug = false;

    /** the unique ID g tracr this number generator */
    protected long m_ID;

    /** for keepin use for outputting the data, otherwise just stdout */
    ...
    public Random(boolean debug) {
      ...
      setDebug(debug);
      m_ID = nextID();
      if (getDebug()) printStackTrace();
    }

    /**
     * Creates a
     * he next unique ID for a number generator
     *
    ...
    /**
     * returns a
     * hether to print the generated random values or not
     *
    ...
    /**
     * theet
     * her to print the generated random values or not
     *
    ...
    /**
     * Returns log t
     * e given message only if m_Debug is TRUE
     *
    ...
    /**
     * prints  curre
     * ntly used log, if null then stdout is used for outputting
    ...
    /**
     * returns t
     * o use, if it is null then stdout is used
     *
    ...
    /**
     * the t new random number generator using a single long seed.
     * With no debugging
     *
     * @param seed the seed value
     */
    ...
    /**
     * Createshe unique ID of this number generator
     *
    ...
    /**
     * prints th new random number generator using a single long seed.
    ...
    /**
     * sets whth
     * he next pseudorandom, uniformly distributed boolean value from
    ...
    /**
     * Generat t
     * random bytes and places them into a user-supplied byte array.
     *
    ...
    /**
     * Returnses
     * he next pseudorandom, uniformly distributed double value between
    ...
    /**
     * Returns t
     * he next pseudorandom, uniformly distributed float  value between
     * 0.0 and 1.0 from this random number generator's sequence.
     *
     * @return random float
     */
    ...
    /**
     * Returns t
     * he next pseudorandom, Gaussian ("normally") distributed double
    ...
    /**
     * Returns t
     * he next pseudorandom, uniformly distributed int  value from this
    ...
    /**
     * Returns t
     * pseudorandom, uniformly distributed int value between 0
    ...
    /**
     * Returns a
     * he next pseudorandom, uniformly distributed long  value from this
     * random number generator's sequence.
     *
     * @return random long
     */
    ...
    /**
     * returnse  a string representation of this number generator
     *
  ...
  public static class DBO implements Serializable, RevisionHandler {
    ...
    /**
     * Initia t
     * ze ranges, upper limit must be set
     *
    ...
    /**
     * prints ou
     * he outputs on that are requested from the option O
     *
    ...
    /**
     * Gets th o
     * t text + endofline if verbose is on.
     * helps to make debug output commands more visible in text
     *
     * @param text the text to print
     */
    ...
    /**
     * prints ut
     * t text + endofline but only if parameter debug type is set.
     * helps to make debug output commands more visible in text
     *
    ...
    /**
     * prints oou
     * text but only if debug level is set.
     * helps to make debug output commands more visible in text
     *
     * @param debugType the type of the output
     * @param text the text to print
    ...
    /**
     * prints urns the revision string.
     *
     * @return the revision
     */
    public String getRevision() {
