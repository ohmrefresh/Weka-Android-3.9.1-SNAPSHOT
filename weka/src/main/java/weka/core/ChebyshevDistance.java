...
/**
 * <!-- globalinfo-start -->
 * Implements the Chebyshev distance. The distance between two vectors is the greatest of their
 * differences along any coordinate dimension.<br/>
 * <br/>
...
public class ChebyshevDistance extends NormalizableDistance implements TechnicalInformationHandler {
  ...
  public String globalInfo() {
    return "Implements the Chebyshev distance. The distance between two vectors "
