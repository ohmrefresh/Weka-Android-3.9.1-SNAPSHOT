...
public class BayesNet extends ClassificationGenerator {
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    result.add(new Option("\tThe number of arcs to use. (default " + defaultNumArcs() + ")", "A", 1,
        "-A <num>"));

    result.add(new Option(
        "\tThe number of attributes to generate. (default " + defaultNumAttributes() + ")", "N", 1,
        "-N <num>"));

    result.add(new Option(
        "\tThe cardinality of the attributes and the class. (default " + defaultCardinality() + ")",
        "C", 1, "-C <num>"));
  ...
  public void setNumArcs(int value) {
    ...
    if (value > maxArcs) {
      ...
      throw new IllegalArgumentException("Number of arcs should be at least (nodes - 1) = "
          + minArcs
          + " instead of "
          + value
          + " (nodes = numAttributes)!");
   ...
   */
  @Override public void setNumExamples(int numExamples) {
