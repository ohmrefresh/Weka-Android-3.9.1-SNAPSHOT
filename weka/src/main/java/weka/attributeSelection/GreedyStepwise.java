...
public class GreedyStepwise extends ASSearch
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tUse a backward search instead of a" + "\n\tforward one.", "-B", 0, "-B"));
    newVector.addElement(
        new Option("\tSpecify a starting set of attributes." + "\n\tEg. 1,3,5-7.", "P", 1,
            "-P <start set>"));
    ...
    newVector.addElement(
        new Option("\tSpecify number of attributes to select", "N", 1, "-N <num to select>"));

    newVector.addElement(
        new Option("\t" + numExecutionSlotsTipText() + " (default 1)\n", "-num-slots", 1,
            "-num-slots <int>"));
  ...
  @Override public String toString() {
    ...
    FString.append(
        "\tGreedy Stepwise (" + ((m_backward) ? "backwards)" : "forwards)") + ".\n\tStart set: ");
   ...
   */
  @Override public int getNumToSelect() {
   ...
   */
  @Override public void setStartSet(String startSet) throws Exception {
   ...
   */
  @Override public String getStartSet() {
   ...
   */
  @Override public int getCalculatedNumToSelect() {
    if (m_numToSelect >= 0) {
   ...
   */
  @Override public boolean getGenerateRanking() {
   ...
   */
  @Override public void setGenerateRanking(boolean doRank) {
