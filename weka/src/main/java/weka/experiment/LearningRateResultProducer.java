...
public class LearningRateResultProducer
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tThe number of steps in the learning rate curve.\n" + "\t(default 10)", "X", 1,
            "-X <num steps>"));
  ...
  @Override public void setAdditionalMeasures(String[] additionalMeasures) {
    ...
    if (m_ResultProducer != null) {
      System.err.println(
          "LearningRateResultProducer: setting additional " + "measures for " + "ResultProducer");
  ...
  @Override public void doRun(int run) throws Exception {
    ...
    while (m_CurrentSize <= m_Instances.numInstances() && ((m_UpperSize == -1) || (m_CurrentSize
        <= m_UpperSize))) {
