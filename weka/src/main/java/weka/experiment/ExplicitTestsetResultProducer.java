...
public class ExplicitTestsetResultProducer
  ...
  protected File m_OutputFile =
      new File(new File(System.getProperty("user.dir")), "splitEvalutorOut.zip");
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    result.addElement(
        new Option("\tThe directory containing the test sets.\n" + "\t(default: current directory)",
            "dir", 1, "-dir <directory>"));
  ...
  @Override public void setAdditionalMeasures(String[] additionalMeasures) {
    ...
    if (m_SplitEvaluator != null) {
      System.err.println(
          "ExplicitTestsetResultProducer: setting additional " + "measures for split evaluator");
  ...
  @Override public void doRun(int run) throws Exception {
    ...
    if (m_ResultListener.isResultRequired(this, key)) {
      ...
      if (train.numAttributes() == test.numAttributes()) {
        ...
        throw new WekaException("Train and test set (= "
            + filename
            + ") "
