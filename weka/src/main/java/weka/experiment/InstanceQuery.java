...
public class InstanceQuery extends DatabaseUtils implements OptionHandler, InstanceQueryAdapter {
  ...
  public static Instances retrieveInstances(InstanceQueryAdapter adapter, ResultSet rs)
    ...
    @SuppressWarnings("unchecked") Hashtable<String, Double>[] nominalIndexes =
        new Hashtable[numAttributes];
    @SuppressWarnings("unchecked") ArrayList<String>[] nominalStrings =
        new ArrayList[numAttributes];
