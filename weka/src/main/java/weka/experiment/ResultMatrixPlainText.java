...
public class ResultMatrixPlainText extends ResultMatrix {
   ...
   * @return the width
   */
  @Override public int getDefaultRowNameWidth() {
    return 25;
  }
   ...
   * @return the width
   */
  @Override public int getDefaultCountWidth() {
    return 5;
  }
   ...
   * @return the matrix
   */
  @Override public String toStringMatrix() {
    StringBuffer result;
    String[][] cells;
    int i;
    int j;
   ...
   * @see #m_HeaderValues
   */
  @Override public String toStringHeader() {
    int i;
    int size;
    String[][] data;
    String result;
   ...
   * @return the key
   */
  @Override public String toStringKey() {
    String result;
    int i;
   ...
   * @return the ranking
   */
  @Override public String toStringRanking() {
    int biggest;
    int width;
    String result;
    int[] ranking;
    ...
    result =
        Utils.padLeft(">-<", width) + ' ' + Utils.padLeft(">", width) + ' ' + Utils.padLeft("<",
            width) + " Resultset\n";
