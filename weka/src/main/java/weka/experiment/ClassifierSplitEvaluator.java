...
public class ClassifierSplitEvaluator
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tAdd target and prediction columns to the result\n" + "\tfor each fold.", "P",
            0, "-P"));
  ...
  @Override public Object[] getResult(Instances train, Instances test) throws Exception {
    ...
    long CPUStartTime = -1, trainCPUTimeElapsed = -1, testCPUTimeElapsed = -1, trainTimeStart,
        trainTimeElapsed, testTimeStart, testTimeElapsed;
