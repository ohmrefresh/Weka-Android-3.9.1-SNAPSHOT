...
public class RegressionAnalysis {
  ...
  public static double calculateRSquared(Instances data, double ssr) throws Exception {
    ...
    for (int i = 0; i < data.numInstances(); i++) {
      tss += (data.instance(i).value(data.classIndex()) - yMean) * (data.instance(i)
          .value(data.classIndex()) - yMean);
    }
   ...
   * @throws Exception if there is a missing class value in data
   */
  public static double[] calculateStdErrorOfCoef(Instances data, Attribute chosen, double slope,
      double intercept, int df) throws Exception {
   ...
   * @throws Exception if there is a missing class value in data
   */
  public static double calculateSSR(Instances data, Attribute chosen, double slope,
   ...
   * @throws Exception if there is a missing class value in data
   */
  public static double[] calculateStdErrorOfCoef(Instances data, boolean[] selected, double ssr,
