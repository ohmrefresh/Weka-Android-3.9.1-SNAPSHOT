...
public abstract class AbstractEvaluationMetric implements Serializable {
  ...
  public static ArrayList<AbstractEvaluationMetric> getPluginMetrics() {
    ...
    Set<String> pluginMetrics =
        PluginManager.getPluginNamesOfType(AbstractEvaluationMetric.class.getName());
    if (pluginMetrics != null) {
      ...
      for (String metric : pluginMetrics) {
        try {
          Object impl =
              PluginManager.getPluginInstance(AbstractEvaluationMetric.class.getName(), metric);
