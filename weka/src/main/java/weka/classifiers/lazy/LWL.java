...
/**
 * <!-- globalinfo-start -->
 * Locally weighted learning. Uses an instance-based algorithm to assign instance weights which are
 * then used by a specified WeightedInstancesHandler.<br/>
...
public class LWL extends SingleClassifierEnhancer
  ...
  public String globalInfo() {
    return "Locally weighted learning. Uses an instance-based algorithm to "
