...
/**
 * <!-- globalinfo-start -->
 * Class for building an ensemble of randomizable base classifiers. Each base classifiers is built
 * using a different random number seed (but based one the same data). The final prediction is a
 * straight average of the predictions generated by the individual base classifiers.
 * <p/>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
 ...
 */
public class RandomCommittee extends RandomizableParallelIteratedSingleClassifierEnhancer
