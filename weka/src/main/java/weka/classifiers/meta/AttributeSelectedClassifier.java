...
/**
 * <!-- globalinfo-start -->
 * Dimensionality of training and test data is reduced by attribute selection before being passed on
 * to a classifier.
 * <p/>
 * <!-- globalinfo-end -->
 *
...
public class AttributeSelectedClassifier extends SingleClassifierEnhancer
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    m_AttributeSelection.
        SelectAttributes(
            (m_Evaluator instanceof WeightedInstancesHandler) ? newData : resampledData);
    ...
    m_ReducedHeader =
        new Instances((m_Classifier instanceof WeightedInstancesHandler) ? newData : resampledData,
            0);
