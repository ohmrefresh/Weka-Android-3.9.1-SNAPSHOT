...
/**
 * <!-- globalinfo-start -->
 * Class for running an arbitrary classifier on data that has been passed through an arbitrary
 * filter. Like the classifier, the structure of the filter is based exclusively on the training
 * data and test instances will be processed by the filter without changing their structure.
 * <p/>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
...
public class RandomizableFilteredClassifier extends FilteredClassifier implements Randomizable {
  ...
  public String globalInfo() {
    return
        "A simple variant of the FilteredClassifier that implements the Randomizable interface, useful for "
  ...
  public Enumeration<Option> listOptions() {
    ...
    if (getFilter() instanceof OptionHandler) {
      ...
      newVector.addAll(Collections.list(getFilter().listOptions()));
    }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (!(m_Classifier instanceof Randomizable) && !(m_Filter instanceof Randomizable)) {
      throw new Exception(
          "Either the classifier or the filter must implement " + "the Randomizable interface.");
    }
