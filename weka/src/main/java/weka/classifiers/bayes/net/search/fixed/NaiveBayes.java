...
/**
 * <!-- globalinfo-start -->
 * The NaiveBayes class generates a fixed Bayes network structure with arrows from the class
 * variable to each of the attribute variables.
 * <p/>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
...
public class NaiveBayes extends SearchAlgorithm {
  ...
  public String globalInfo() {
    return "The NaiveBayes class generates a fixed Bayes network structure "
