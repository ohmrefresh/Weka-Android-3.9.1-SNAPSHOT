...
/**
 * <!-- globalinfo-start -->
 * The CISearchAlgorithm class supports Bayes net structure search algorithms that are based on
 * conditional independence test (as opposed to for example score based of cross validation based
 * search algorithms).
 * <p/>
 * <!-- globalinfo-end -->
 *
...
public class CISearchAlgorithm extends LocalScoreSearchAlgorithm {
  ...
  public String globalInfo() {
    return "The CISearchAlgorithm class supports Bayes net structure "
   ...
   */
  protected boolean isConditionalIndependent(int iAttributeX, int iAttributeY, int[] iAttributesZ,
      int nAttributesZ) {
