...
public abstract class AbstractClassifier
    implements Classifier, BatchPredictor, Cloneable, Serializable, OptionHandler,
    CapabilitiesHandler, RevisionHandler, CapabilitiesIgnorer, CommandlineRunnable {
   ...
   */
  @Override public boolean getDoNotCheckCapabilities() {
   ...
   */
  @Override public void setDoNotCheckCapabilities(boolean doNotCheckCapabilities) {
   ...
   */
  @Override public String getBatchSize() {
    return m_BatchSize;
  }
   ...
   */
  @Override public double[][] distributionsForInstances(Instances batch) throws Exception {
