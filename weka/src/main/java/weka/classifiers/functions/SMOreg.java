...
/**
 * <!-- globalinfo-start -->
 * SMOreg implements the support vector machine for regression. The parameters can be learned using
 * various algorithms. The algorithm is selected by setting the RegOptimizer. The most popular
 * algorithm (RegSMOImproved) is due to Shevade, Keerthi et al and this is the default
 * RegOptimizer.<br/>
 * <br/>
 * For more information see:<br/>
 * <br/>
 * S.K. Shevade, S.S. Keerthi, C. Bhattacharyya, K.R.K. Murthy: Improvements to the SMO Algorithm
 * for SVM Regression. In: IEEE Transactions on Neural Networks, 1999.<br/>
 * <br/>
 ...
 */
public class SMOreg extends AbstractClassifier
  ...
  public String globalInfo() {
    return "SMOreg implements the support vector machine for regression. "
  ...
  public String[] getOptions() {
    ...
    result.add("-I");
    result.add("" + getRegOptimizer().getClass().getName() + " " + Utils.joinOptions(
        getRegOptimizer().getOptions()));
