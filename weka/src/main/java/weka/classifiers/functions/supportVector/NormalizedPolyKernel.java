...
public class NormalizedPolyKernel extends PolyKernel {
  ...
  public String toString() {
    ...
    if (getUseLowerOrder()) {
      result =
          "Normalized Poly Kernel with lower order: K(x,y) = (<x,y>+1)^" + getExponent() + "/" +
  ...
  public double eval(int id1, int id2, Instance inst1) throws Exception {
    ...
    double div = Math.sqrt(
        super.eval(id1, id1, inst1) * ((m_keys != null) ? super.eval(id2, id2, m_data.instance(id2))
