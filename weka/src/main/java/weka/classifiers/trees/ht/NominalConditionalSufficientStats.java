...
public class NominalConditionalSufficientStats extends ConditionalSufficientStats
  ...
  @Override
  public SplitCandidate bestSplit(SplitMetric splitMetric, Map<String, WeightMass> preSplitDist,
      String attName) {
    ...
    SplitCandidate candidate =
        new SplitCandidate(new UnivariateNominalMultiwaySplit(attName), postSplitDists, merit);
  ...
  protected List<Map<String, WeightMass>> classDistsAfterSplit() {
    ...
    Map<Integer, Map<String, WeightMass>> splitDists =
        new HashMap<Integer, Map<String, WeightMass>>();
