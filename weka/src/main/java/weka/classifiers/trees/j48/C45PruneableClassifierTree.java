...
public class C45PruneableClassifierTree extends ClassifierTree {
  ...
  protected ClassifierTree getNewTree(Instances data) throws Exception {
    ...
    C45PruneableClassifierTree newTree =
        new C45PruneableClassifierTree(m_toSelectModel, m_pruneTheTree, m_CF, m_subtreeRaising,
            m_cleanup, m_collapseTheTree);
  ...
  public void prune() throws Exception {
    ...
    if (!m_isLeaf) {
      ...
      if (Utils.smOrEq(errorsLeaf, errorsTree + 0.1) && Utils.smOrEq(errorsLeaf,
          errorsLargestBranch + 0.1)) {
  ...
  private double getEstimatedErrorsForDistribution(Distribution theDistribution) {
    ...
    if (Utils.eq(theDistribution.total(), 0)) {
      ...
      return theDistribution.numIncorrect() + Stats.addErrs(theDistribution.total(),
