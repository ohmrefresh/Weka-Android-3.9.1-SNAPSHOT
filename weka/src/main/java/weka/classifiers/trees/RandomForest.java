...
public class RandomForest extends Bagging {
   ...
   */
  @Override protected String[] defaultClassifierOptions() {
   ...
   * @throws if argument is not true
   */
  ...
  @Override public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(
        new Option("\tNumber of iterations.\n" + "\t(current value " + getNumIterations() + ")",
            "I", 1, "-I <num>"));
   ...
   */
  @Override public void setBatchSize(String size) {
  ...
  @Override public void setOptions(String[] options) throws Exception {
    ...
    RandomTree classifier =
        ((RandomTree) AbstractClassifier.forName(defaultClassifierString(), options));
  ...
  @Override public String getRevision() {
    return RevisionUtils.extract("$Revision: 12897 $");
  }
}
