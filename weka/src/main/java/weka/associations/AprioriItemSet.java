...
public class AprioriItemSet extends ItemSet implements Serializable, RevisionHandler {
   ...
   * @throws Exception if singletons can't be generated successfully
   */
  public static ArrayList<Object> singletons(Instances instances, boolean treatZeroAsMissing)
      throws Exception {
   ...
   */
  public static ArrayList<Object> mergeAllItemSets(ArrayList<Object> itemSets, int size,
      int totalTrans) {
  ...
  public ArrayList<Object>[] generateRules(double minConfidence,
    ...
    ArrayList<Object> premises = new ArrayList<Object>(), consequences = new ArrayList<Object>(),
        conf = new ArrayList<Object>();
    // TODO
    ArrayList<Object> lift = new ArrayList<Object>(), lev = new ArrayList<Object>(), conv =
  ...
  public final ArrayList<Object>[] generateRulesBruteForce(double minMetric, int metricType,
    ...
    ArrayList<Object> premises = new ArrayList<Object>(), consequences = new ArrayList<Object>(),
        conf = new ArrayList<Object>(), lift = new ArrayList<Object>(), lev =
        new ArrayList<Object>(), conv = new ArrayList<Object>();
      ...
      if (numItemsInPremise < numItemsInSet) {
        ...
        if (significanceLevel != -1) {
          ...
          contingencyTable[1][1] =
              (numTransactions - premise.m_counter - consequenceUnconditionedCounter
        ...
        if (metricType == 0) {
          ...
          if ((!(metric < minMetric)) && (significanceLevel == -1 || !(chiSquared
              > significanceLevel))) {
            premises.add(premise);
            consequences.add(consequence);
            ...
            lev.add(new Double(leverageForRule(premise, consequence, premise.m_counter,
                consequenceUnconditionedCounter)));
            conv.add(new Double(convictionForRule(premise, consequence, premise.m_counter,
                consequenceUnconditionedCounter)));
          }
        } else {
   ...
   */
  public double leverageForRule(AprioriItemSet premise, AprioriItemSet consequence,
      int premiseCount, int consequenceCount) {
    double coverageForItemSet = (double) consequence.m_counter / (double) m_totalTransactions;
    double expectedCoverageIfIndependent =
        ((double) premiseCount / (double) m_totalTransactions) * ((double) consequenceCount
   ...
   */
  public double convictionForRule(AprioriItemSet premise, AprioriItemSet consequence,
      int premiseCount, int consequenceCount) {
    double num = (double) premiseCount * (double) (m_totalTransactions - consequenceCount)
        / m_totalTransactions;
    double denom = ((premiseCount - consequence.m_counter) + 1);

    if (num < 0 || denom < 0) {
      System.err.println("*** " + num + " " + denom);
      System.err.println("premis count: "
          + premiseCount
          + " consequence count "
          + consequenceCount
          + " total trans "
   ...
   */
  @SuppressWarnings("unchecked") private final ArrayList<Object>[] moreComplexRules(
      ArrayList<Object>[] rules, int numItemsInSet, int numItemsInConsequence, double minConfidence,
      ArrayList<Hashtable<ItemSet, Integer>> hashtables) {

    AprioriItemSet newPremise;
    ArrayList<Object>[] result, moreResults;
    ArrayList<Object> newConsequences, newPremises = new ArrayList<Object>(), newConf =
        new ArrayList<Object>();
    ...
    if (numItemsInSet > numItemsInConsequence + 1) {
      ...
      while (enu.hasMoreElements()) {
        ...
        double tempLev = leverageForRule(newPremise, current, newPremise.m_counter,
            consequenceUnconditionedCounter);
        double tempConv = convictionForRule(newPremise, current, newPremise.m_counter,
            consequenceUnconditionedCounter);
      ...
      moreResults =
          moreComplexRules(result, numItemsInSet, numItemsInConsequence + 1, minConfidence,
              hashtables);
      if (moreResults != null) {
        for (int i = 0; i < moreResults[0].size(); i++) {
   ...
   */
  @Override public final String toString(Instances instances) {
