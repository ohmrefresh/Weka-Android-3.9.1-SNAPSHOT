...
public class NumericItem extends Item implements Serializable {
   ...
   */
  @Override public String getItemValueAsString() {
   ...
   */
  @Override public String getComparisonAsString() {
    String result = null;
  ...
  @Override public boolean equals(Object compareTo) {
    ...
    return m_attribute.equals(b.getAttribute()) && m_comparison == b.getComparison() && (new Double(
        m_splitPoint).equals(new Double(b.getSplitPoint())));
  }
