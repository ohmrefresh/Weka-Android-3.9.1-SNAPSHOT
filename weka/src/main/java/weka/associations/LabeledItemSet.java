...
public class LabeledItemSet extends ItemSet implements Serializable, RevisionHandler {
   ...
   */
  public static ArrayList<Object> deleteItemSets(ArrayList<Object> itemSets, int minSupport,
      int maxSupport) {
   ...
   */
  public static Hashtable<ItemSet, Integer> getHashtable(ArrayList<Object> itemSets,
      int initialSize) {
   ...
   */
  public static ArrayList<Object> singletons(Instances instancesNoClass, Instances classes)
      throws Exception {
  ...
  public static void upDateCountersTreatZeroAsMissing(ArrayList<LabeledItemSet> itemSets,
    ...
    for (int i = 0; i < instancesNoClass.numInstances(); i++) {
      ...
      while (enu.hasMoreElements()) {
        enu.nextElement()
            .upDateCounterTreatZeroAsMissing(instancesNoClass.instance(i),
                instancesClass.instance(i));
      }
    }
  }
   ...
   */
  @Override public final boolean equals(Object itemSet) {

    if (!(this.equalCondset(itemSet))) {
      return false;
    }
    return m_classLabel == ((LabeledItemSet) itemSet).m_classLabel;
  }
   ...
   * @return the support
   */
  @Override public final int support() {
